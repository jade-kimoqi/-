...
public class MpGenerator {
    ...
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://192.168.159.131:3316/tingshu_account?serverTimezone=GMT%2B8",
                        "root",
                        "123")
                .globalConfig(builder -> {
                    builder.author("long") // 设置作者
                            ...
                            .disableOpenDir()
                            .outputDir("C:\\study\\230710\\code\\tingshu_parent\\tingshu_core\\tingshu_account\\src\\main\\java"); // 指定输出目录
                })
...
////        strategy.setInclude("order_info","order_detail","order_derate");
