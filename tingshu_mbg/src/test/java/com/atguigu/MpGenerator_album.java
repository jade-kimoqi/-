...
public class MpGenerator_album {
    //具体设置 https://blog.csdn.net/cx19910829/article/details/126889724
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://192.168.159.131:3316/tingshu_album?serverTimezone=GMT%2B8",
                        "root",
                        "123")
                .globalConfig(builder -> {
                    builder.author("long") // 设置作者
                            ...
                            .disableOpenDir()
                            .outputDir("C:\\study\\230710\\code\\tingshu_parent\\tingshu_core\\tingshu_album\\src\\main\\java"); // 指定输出目录
                })
